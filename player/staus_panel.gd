...
@onready var health_bar: TextureProgressBar = $V/Health/HealthBar
@onready var eased_health_bar: TextureProgressBar = $V/Health/HealthBar/EasedHealthBar
@onready var energy_bar: TextureProgressBar = $V/Energy/EnergyBar
@onready var energy_num: Label = $V/Energy/EnergyNum
@onready var health_num: Label = $V/Health/HealthNum
@onready var material_num: Label = $"../HBoxContainer/Material_num"
